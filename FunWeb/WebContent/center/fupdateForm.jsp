...
<table id="notice">
<tr><td>글쓴이</td><td><input type="text" name="name" value="<%=fbb.getName() %>"></td></tr>
<tr><td>제목</td><td><input type="text" name="subject" value="<%=fbb.getSubject()%>"></td></tr>
<tr><td>파일</td><td><input type="file" name="file"><input type="hidden" name="oldfile" value="<%=fbb.getFile()%>">
<%=fbb.getFile() %></td></tr>
<tr><td>내용</td>
	<td><textarea name="content" rows="10" cols="20"><%=fbb.getContent() %></textarea></td></tr>
