...
//파라미터 바구니에 담아 전달
//패키지 member 파일이름 MemberBean 멤버변수 id pass name date
//MemberBean 사용하기 위해 기억장소 확보(객체생성) mb
//멤버변수 <= 파라미터값 저장 set() 메서드 호출
...
mb.setDate(date);
//DB작업 만들기
//패키지 membrr 파일이름 MembrDAO 만들기
//리턴형 없음 insertMembrer(주소) 메서드 정의
//MemberDAO mdao 객체생성
